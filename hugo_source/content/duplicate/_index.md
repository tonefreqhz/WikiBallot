---
title: "Duplicate This Dongle"
description: "Every copy is a node. Every node is sovereign."
---

This is the most important page on this device.

Copy everything here onto a USB stick. Hand it to someone. That person is now a node. There is no centre. There is no single point of capture.

**Cost per dongle: £1.80-£4.00. One per active constituency node.**
...
- Boot from USB - no installation required in live mode
